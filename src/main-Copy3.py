        ...
        with open(data_path, encoding='utf-8') as reader:
            for i, line in enumerate(reader):
                ...
                for key in ['B', 'C']:
                    ...
                    text_b = tokenization.convert_to_unicode(b)
...
export BERT_BASE_DIR=./chinese_L-12_H-768_A-12
CUDA_VISIBLE_DEVICES=0 python main-Copy3.py \
  --task_name=task3 \
  --do_train=True \
  --train_path=../input/SCM_5k.json \
  --do_eval=False \
  ...
  --learning_rate=2e-5 \
  --num_train_epochs=10.0 \
  --output_dir=../tmp/main-Copy3_big_data_pool_epochs_10_lr2e-5/
...
CUDA_VISIBLE_DEVICES=0 python main-Copy3.py \
  ...
  --learning_rate=1e-5 \
  --num_train_epochs=15.0 \
  --output_dir=../tmp/main-Copy3_big_data_pool_epochs_15_lr1e-5/  
