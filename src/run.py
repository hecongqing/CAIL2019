...
t_job= te.TensorFlow(entry_point = '/mnt/hecongqing1/cail/src/main6593.py', \
                       train_gpu_count = 1,
                       hyperparameters = {'task_name':"task3","do_train":True, "train_path":"../input/SCM_5k.json",
                                          ...
                                          "save_checkpoints_steps":500,"max_seq_length":512,"train_batch_size":16,
                                          "learning_rate":2e-5,"num_train_epochs":10.0,
                                          "output_dir":"../output/main6593/"}
                      )
